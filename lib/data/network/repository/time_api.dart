...
class TimeAPI {
  ...
  // Future<dynamic> setCustomerData(List list) async{
    
  //   dynamic response = await _networkCall.doRequest(path: CUSTOMER_REGISTER_OR_REFRESH_PASSWORD, method: 'GET', context: null,requestParams: [l]);
  ...
  // Future <dynamic> registerClientData() async {

  //   dynamic response = await _networkCall.doRequest(path: 'requestUrl', method: 'POST', context: null);
  ...
  // //Auth users(Clients & Specialists)
  // Future<dynamic> loginClient(String serviceType) async {

  //   dynamic response = await _networkCall.doRequest(path: AUTHORIZE, method: 'POST', context: null);

    

  // }

  // Future<dynamic> loginSpecialsit(String serviceType) async {
  //   // dynamic response = await _networkCall.doRequest(path: CHECK_TOKEN, method: 'POST', context: null,requestParams: ,body: ['asd']);
